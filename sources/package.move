...
module vetoken::package {
    ...
    //                                                                        //
    const DEPLOYER_ADDRESS: address = @vetoken_deployer;                      //
    const RESOURCE_ACCOUNT_SEED: vector<u8> = b"vetoken";                     //
    const RESOURCE_ACCOUNT_ADDRESS: address = @vetoken;                       //
    //                                                                        //
    //                                                                        //
    // *************************************************************************
    ...
    fun publish_package_unauthorized_err(vetoken: &signer) acquires ResourceSignerCapability {
        // setup the manager & package resource
        thala_manager::manager::initialize_for_test(signer::address_of(vetoken));
        init_for_test();
